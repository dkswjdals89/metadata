...
#########################################################
# python
import os, sys, traceback, re, json, datetime, lxml, time
# third-party
import requests
...
# import sites
# from lib_metadata import SiteUtil, SiteFc2Com, SiteJavdb, SiteBp4x, SiteFc2Cm, SiteFc2Hub, Site7mmTv
    ...
    def search(self, keyword, manual=False):
        ...
        for idx, site in enumerate(site_list):
            if site == 'fc2com':
                ...
                from lib_metadata.site_fc2.site_fc2cm import SiteFc2Cm as SiteClass
            elif site == 'fc2hub':
                from lib_metadata.site_fc2.site_fc2hub import SiteFc2Hub as SiteClass
            elif site == '7mmtv':
                from lib_metadata.site_fc2.site_7mmtv import Site7mmTv as SiteClass
    ...
    def info(self, code):
        ...
        if ret is None:
            if code[1] == 'F':
                ...
                from lib_metadata.site_fc2.site_fc2cm import SiteFc2Cm
                ret = self.info2(code, SiteFc2Cm)
            elif code[1] == 'H':
                from lib_metadata.site_fc2.site_fc2hub import SiteFc2Hub
                ret = self.info2(code, SiteFc2Hub)
            elif code[1] == '7':
                from lib_metadata.site_fc2.site_7mmtv import Site7mmTv
